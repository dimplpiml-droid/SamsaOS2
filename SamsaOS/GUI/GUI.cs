    ...
    public class GUI
    {
        ...
        public static string Init(string overrideRes = null, string customCanvas = "")
        {
            try
            {
                ...
                //if (!Kernel.safeMode) { canvas.DrawImage(new Bitmap(Resources.Wallpaper), 0, 0); canvas.DrawFilledRectangle(DarkPen, ((int)(GUI.ScreenX - "Starting samsaos".Length * 8) / 2) - 10, (int)(GUI.ScreenY - 12) / 2, "Starting samsaos".Length * 8 + 20, 24); }
                //canvas.DrawString("samsaos", font, new Pen(Color.LimeGreen), (int)(GUI.ScreenX - "samsaos".Length * font.Width) / 2, (int)(GUI.ScreenY - font.Height * 2) / 2);
