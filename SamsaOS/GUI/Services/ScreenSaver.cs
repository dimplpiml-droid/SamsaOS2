...
namespace SamsaOS.GUI
{
    public class ScreenSaver
    {
        ...
        public static void Update()
        {
            ...
            Font.DrawString(SamsaOS.Date.CurrentTime(true),System.Drawing.Color.White, (int)GUI.ScreenX - 200, (int)GUI.ScreenY - 36);
            Font.DrawString(SamsaOS.Date.CurrentDate(true, false), System.Drawing.Color.White, (int)GUI.ScreenX - 200, (int)GUI.ScreenY - 20);
        }
    }
