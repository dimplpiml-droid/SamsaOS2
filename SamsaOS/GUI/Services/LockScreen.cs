...
namespace SamsaOS.GUI
{
    public class LockScreen
    {
        ...
        public static void Update()
        {
            ...
            Font.DrawString(SamsaOS.Date.CurrentTime(false),Color.White, (int)GUI.ScreenX / 2 - 30, (int)GUI.ScreenY / 3 - 80);
            Font.DrawString(SamsaOS.Date.CurrentDate(true, false),Color.White, (int)GUI.ScreenX / 2 - 80, (int)GUI.ScreenY / 3 - 60);
            if (Menu)
            {
            ...
            {
                if (SamsaOS.Date.CurrentSecond()[0] != second10)
                {
                    second10 = SamsaOS.Date.CurrentSecond()[0];
