...
namespace SamsaOS.Commands
{
    ...
    {
        internal About() : base
            ("About", "Provides info about SamsaOS",
            new Command[] {
            new Command(new string[] { "about", "info"}, "Display info about SamsaOS"),
            new Command(new string[] { "ver", "version"}, "Display SamsaOS version")
            })
        {
        }
        internal override int Execute(string[] args, string rawInput, CommandShell shell)
        {
            ...
            {
                shell.Print = "SamsaOS\n" +
                    Kernel.OSVERSION + "\n\nBased on CosmosOS" + "\nCreated by Ncleardev\nGithub: https://github.com/Ncleardev/SamsaOS \nWebsite: https://ncleardev.github.io/samsaos";
                return 0;
            }
